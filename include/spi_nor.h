...
int spi_block_erase_20(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_50(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_52(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_60(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_62(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_81(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_c4(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_c7(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_d7(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_d8(struct context *flash, off_t addr,
		       size_t blocklen);
int spi_block_erase_db(struct context *flash, off_t addr,
		       size_t blocklen);
...
int spi_byte_program(struct context *flash, off_t addr,
		     uint8_t databyte);
size_t spi_nbyte_program(struct context *flash, off_t addr,
		      const uint8_t *bytes, size_t len);
size_t spi_nbyte_read(struct context *flash, off_t addr, uint8_t *bytes,
		   size_t len);
